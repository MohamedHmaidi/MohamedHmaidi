...
### 🔧 Cloud Systems Reporting Intern | Next Step IT
*July 2024 - September 2024*
- Designed integrated architecture with Nakivo, Zimbra, and vCenter
- Developed automated backend with PowerShell scripts
- Created interactive dashboards with PDF reporting capabilities

### ⚙️ DevOps Intern | Société Générale d'Automatisme
*June 2023 - August 2023*
- Implemented automated CI/CD pipeline with Jenkins
- Containerized Spring Boot & Angular applications
- Deployed on Kubernetes with quality and security focus
